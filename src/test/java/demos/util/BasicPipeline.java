...
public class BasicPipeline {
    ...
    public static long createPipeline(
            VkPhysicalDevice physicalDevice, VkDevice logicalDevice, long renderPass)
        ...
        loadShaderStage(
                stages.get(0),
                createShaderModule(
                        logicalDevice, new File("storage/res/shaders/triangle.vert.spv")),
        ...
        loadShaderStage(
                stages.get(1),
                createShaderModule(
                        logicalDevice, new File("storage/res/shaders/triangle.frag.spv")),
