...
public class Attachments implements Destroyable {
    ...
    /** Default values for the configuration file. */
    public static final Integer DEFAULT_FLAGS = 0, DEFAULT_ATTACHMENT_COUNT = 1;
     ...
     * @throws AssertionError If failed to create JSON file, or when failed to obtain a value from
