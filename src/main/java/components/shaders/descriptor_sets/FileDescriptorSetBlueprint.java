...
import static main.java.components.pipeline.PipelineUtil.*;
...
public class FileDescriptorSetBlueprint implements DescriptorSetBlueprint, Destroyable {
    ...
    private static final Logger logger =
            Logger.getLogger(FileDescriptorSetBlueprint.class.getName());

    /** Keys for loading data from JSON files. */
    private static final String BINDINGS_COUNT_KEY = "bindingsCount",
    ...
    private static final Integer DEFAULT_BINDINGS_COUNT = 0,
