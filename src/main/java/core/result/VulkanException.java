...
/**
 * Class representing an exception caused by the vulkan loader.
 *
...
public class VulkanException extends Exception {
    ...
    /**
     * Creates a new VulkanException with the exception type corresponding to the given exception
     * number.
     *
    ...
    /**
     * Creates a new VulkanException with the exception type corresponding to the given exception
     * number and with the given message.
     *
     * @param exceptionNumber Vulkan exception number.
    ...
    /**
     * Creates a new VulkanException with the given exception type.
     *
    ...
    /**
     * Creates a new VulkanException with the given exception type and message.
     *
     * @param exception Vulkan exception type.
     * @param message Exception message.
     */
