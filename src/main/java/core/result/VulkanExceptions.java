package main.java.core.result;

import java.util.HashMap;

/**
 * Enum for representing exceptions that can be thrown by Vulkan loader.
 *
...
public enum VulkanExceptions {
    ...
    private static final HashMap<Integer, VulkanExceptions> exceptions =
            new HashMap<Integer, VulkanExceptions>();
    ...
    /**
     * Creates a new enum VulkanExceptions with the given exception number, and name.
     *
    ...
    /**
     * Returns a Vulkan exception type corresponding to the given exception ID number.
     *
