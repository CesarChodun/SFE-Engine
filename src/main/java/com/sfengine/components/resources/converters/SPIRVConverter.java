package com.sfengine.components.resources.converters;

import com.sfengine.components.resources.Converter;
...
public class SPIRVConverter implements Converter {
    ...
    private static final String[] EXT = {
        "conf", "vert", "tesc", "tese", "geom", "frag", "comp", "mesh", "task", "rgen", "rint",
        "rahit", "rchit", "rmiss", "rcall", "glsl", "hlsl"
    };
    ...
    public void convert(File from, File to) {
        ...
        logger.log(
                ...
                "Converting "
                        + from.getPath()
                        + " to SPIRV shader and saveing it to "
                        + newOut.getPath());
