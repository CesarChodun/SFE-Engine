package com.sfengine.components.shaders;

import static com.sfengine.components.memory.RenderingMemoryUtil.*;
...
import com.sfengine.components.memory.GPUBuffer;
...
public class GeneralizedDescriptorValue implements DescriptorValue {
    ...
    public void setUniform(int index, Matrix4f val) {
        checkCompatibility(index, UniformUsage.UNIFORM_USAGE_MATRIX_4F);
