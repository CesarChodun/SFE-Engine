...
public class Window {
    ...
    /**
     * Creates a full screen window, or a window with default dimensions.
     *
     * @param instance The Vulkan instance.
     * @param name Name of the window.
     * @param fullScreen If true window will be created as full screen window, and if false it will
     *     be a windowed one.
     * @throws VulkanException When the window creation process fails.
     */
    public Window(VkInstance instance, String name, int width, int height, boolean fullScreen)
     ...
     * @throws VulkanException When the window creation process fails.
     */
    public Window(VkInstance instance, String name, int x, int y, int width, int height)
            throws VulkanException {
        this.x = x;
        this.y = y;
        this.height = height;
    ...
    private void createWindow(VkInstance instance, long monitor) throws VulkanException {
        ...
        VulkanResult.validate(err, "Failed to create surface!");
