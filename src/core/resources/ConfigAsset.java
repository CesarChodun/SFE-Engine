...
public class ConfigAsset {
	...
	/**
	 * Creates a new configuration data from the asset,
	 ...
	 */
	public int getFlags(Class<?> source, String key, String defaultFlag) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
