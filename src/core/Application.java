...
/**
 * Class providing basic information about the application and engine.
 *
...
public class Application {
    ...
    public static final boolean RELEASE =
            Boolean.valueOf(System.getProperty("application_release", "true"));
    /** Application debug mode(provides extra logging information). */
    public static final boolean DEBUG =
            Boolean.valueOf(System.getProperty("application_debug", "false"));
     ...
     */
    private static VkApplicationInfo createAppInfo(Asset asset)
        ...
        appInfo.sType(VK_STRUCTURE_TYPE_APPLICATION_INFO)
                .apiVersion(
                        VK_MAKE_VERSION(
                                cfg.getInteger(API_MAJOR_KEY, DEFAULT_API_MAJOR),
                                cfg.getInteger(API_MINOR_KEY, DEFAULT_API_MINOR),
                                cfg.getInteger(API_PATCH_KEY, DEFAULT_API_PATCH)));
        appInfo.pEngineName(memUTF8(cfg.getString(ENGINE_NAME_KEY, DEFAULT_ENGINE_NAME)))
                .engineVersion(
                        VK_MAKE_VERSION(
                                cfg.getInteger(ENGINE_MAJOR_KEY, DEFAULT_ENGINE_MAJOR),
                                cfg.getInteger(ENGINE_MINOR_KEY, DEFAULT_ENGINE_MINOR),
                                cfg.getInteger(ENGINE_PATCH_KEY, DEFAULT_ENGINE_PATCH)))
                .pApplicationName(
                        memUTF8(cfg.getString(APPLICATION_NAME_KEY, DEFAULT_APPLICATION_NAME)))
                .applicationVersion(
                        VK_MAKE_VERSION(
                                cfg.getInteger(APP_MAJOR_KEY, DEFAULT_APP_MAJOR),
                                cfg.getInteger(APP_MINOR_KEY, DEFAULT_APP_MINOR),
                                cfg.getInteger(APP_PATCH_KEY, DEFAULT_APP_PATCH)));
    ...
    /** Destroys the allocated data. <b>Note:</b> must be invoked on the main thread. */
