...
public class WindowManager implements EngineTask {
    ...
    /** A class that will perform the window(and engine) shut down. */
    ...
    /** A class that will monitor if the window should close, and poll the GLFW events. */
    ...
    /** A class that will create the window and add the window per tick task to the engine. */
