...
/**
 * Converts shader programs from the resources
 * package. Runs concurrently so it is required
...
public class DefaultResourceConverter {
	...
	/**
	 * Runs conversion on the resources package saving results
	 * to the storage folder.
	 * 
	 * Must not be run multiple times within the application lifetime.
	 */
