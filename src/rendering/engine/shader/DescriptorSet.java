...
public abstract class DescriptorSet implements Destroyable{
	...
	/**
	 * Tells whether all of the descriptors within
	 * the set are up to date.
	 * 
	 * @return true if all of the descriptors are up to date 
	 * 		and false otherwise.
	 */
	 ...
	 * @return	the previous descriptor associated with the name or null
	 * 		if there is no such a descriptor.
	 */
