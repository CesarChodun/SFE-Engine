...
/**
 * Class that loads and stores
 * the VKImageViewCreateInfo object. 
 * 
...
public class ImageViewCreateInfo implements Destroyable {
     ...
     */
    public ImageViewCreateInfo(Asset assetPackage, String configurationFileName) throws AssertionError, IOException {
    ...
    private void loadDataFromAsset() throws AssertionError, IOException {
        ...
        info
            ...
            .viewType(cfg.getStaticIntFromClass(VK10.class, VIEW_TYPE_KEY, DEFAULT_VIEW_TYPE))
            .format(cfg.getStaticIntFromClass(VK10.class, COLOR_FORMAT_KEY, DEFAULT_COLOR_FORMAT));
        ...
        info.components()
            ...
            .a(cfg.getStaticIntFromClass(VK10.class, COMPONENTS_A_KEY, DEFAULT_COMPONENT_A));
        
        info.subresourceRange()
            .aspectMask(cfg.getStaticIntFromClass(VK10.class, SUB_ASPECT_MASK_KEY, DEFAULT_ASPECT_MASK))
            ...
            .baseArrayLayer(cfg.getInteger(SUB_BASE_ARRAY_LAYER_KEY, DEFAULT_BASE_ARRAY_LAYER))
            .levelCount(cfg.getStaticIntFromClass(VK10.class, SUB_LEVEL_COUNT_KEY, DEFAULT_LEVEL_COUNT));
        }
        catch (Exception e) {
            e.printStackTrace();
