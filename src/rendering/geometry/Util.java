...
/**
 * Util class that helps with the memory
 * management within the geometry package.
 * 
...
public class Util {
	 ...
	 */
	  ...
	  */
	 public static long createBuffer(VkDevice device, long size, int usage, int flags) throws VulkanException {
	  ...
	  */
	 public static VkMemoryAllocateInfo getMemoryAllocateInfo(VkPhysicalDevice physicalDevice, VkDevice device, long bufferHandle) {
	  ...
	  * @param memAlloc		
	  * 	A pointer to an instance of the VkMemoryAllocateInfo 
	  * 	structure describing parameters of the allocation. 
	  * 
	  * @return 	
	  * 	VkDeviceMemory handle in which information about 
	  * 	the allocated memory is returned.
	  * 
	  * @throws VulkanException	When failed to allocate memory.
	  */
	 public static long allocateMemory(VkDevice device, VkMemoryAllocateInfo memAlloc) throws VulkanException {
	  ...
	  */
	 public static long mapMemory(VkDevice device, long memory, VkMemoryAllocateInfo memAlloc) throws VulkanException {
	  ...
	  */
	 public static long createVerticesBuffer(VkPhysicalDevice physicalDevice, VkDevice device, ByteBuffer verticesData) throws VulkanException {
		 
		 long handle = createBuffer(device, verticesData.remaining(), VK_BUFFER_USAGE_VERTEX_BUFFER_BIT, 0);
